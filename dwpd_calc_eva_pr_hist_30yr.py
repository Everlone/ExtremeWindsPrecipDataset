'''
dwpd_calc_eva_ws_hist_30yr.py
Loads annual maxima and exceedances.
Calculates and save the return levels for 2, 5, 10, 20, 30, 50, 70, and 100 years.
...
#for dsi in range(3):
    FileName = 'pr5d_hist_' + DS_Name[dsi] + '.dpkl'
    ...
    fnout = # Path removed in online shared codes for security + DS_Name[dsi] + '_pr5d_hist_gpd_maps.dpkl'
    ...
    del amx, exs, exs_lambda, threshold, vecamx, vecexs, veclmd, vecth, lat, lon, GEV_R2, GEV_R5, GEV_R10, GEV_R20, GEV_R30, GEV_R50, GEV_R70, GEV_R100, GEV_R200, GPD_R2, GPD_R5, GPD_R10, GPD_R20, GPD_R30, GPD_R50, GPD_R70, GPD_R100, GPD_R200, GEV_location, GEV_scale, GEV_shape, GPD_location, GPD_scale, GPD_shape 
